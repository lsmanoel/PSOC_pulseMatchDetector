...
module top ;
	...
	cy_clock_v1_0
		#(.id("6f80e3c7-3bbc-48cb-b91c-f6df6bf14652"),
    ...
    CyControlReg_v1_80 matchCounterControl_Reg_1 (
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam matchCounterControl_Reg_1.Bit0Mode = 0;
    defparam matchCounterControl_Reg_1.Bit1Mode = 0;
    defparam matchCounterControl_Reg_1.Bit2Mode = 0;
    defparam matchCounterControl_Reg_1.Bit3Mode = 0;
    defparam matchCounterControl_Reg_1.Bit4Mode = 0;
    defparam matchCounterControl_Reg_1.Bit5Mode = 0;
    defparam matchCounterControl_Reg_1.Bit6Mode = 0;
    defparam matchCounterControl_Reg_1.Bit7Mode = 0;
    defparam matchCounterControl_Reg_1.BitValue = 0;
    defparam matchCounterControl_Reg_1.BusDisplay = 0;
    defparam matchCounterControl_Reg_1.ExtrReset = 0;
    defparam matchCounterControl_Reg_1.NumOutputs = 8;

    CyStatusReg_v1_90 NMatch_Reg_1 (
        .status_0(1'b0),
        .status_1(1'b0),
        .status_2(1'b0),
        .status_3(1'b0),
    ...
    defparam NMatch_Reg_1.Bit2Mode = 0;
    defparam NMatch_Reg_1.Bit3Mode = 0;
    defparam NMatch_Reg_1.Bit4Mode = 0;
    defparam NMatch_Reg_1.Bit5Mode = 0;
    defparam NMatch_Reg_1.Bit6Mode = 0;
    defparam NMatch_Reg_1.Bit7Mode = 0;
    defparam NMatch_Reg_1.BusDisplay = 1;
    defparam NMatch_Reg_1.Interrupt = 0;
    defparam NMatch_Reg_1.MaskValue = 0;
    defparam NMatch_Reg_1.NumInputs = 8;
