...
public class interface_1 extends PApplet {
...
{  
    ...
    {      
      ...
      {     
        data_in_int[i] = PApplet.parseInt(data_in[i]) + PApplet.parseByte(128);
...
public void actionPerformed (GUIEvent e) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "interface_1" };
    if (passedArgs != null) {
